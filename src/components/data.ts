const data = [
    ...
    },
    {
        ...
        desc: "In a future British dystopian society, a shadowy freedom fighter, known only by the alias of `quot;V`quot;, plots to overthrow the tyrannical government - with the help of a young woman.",
    ...
    },
    {
        ...
        image_url: "https://m.media-amazon.com/images/I/71MRrvu3zPL.jpg",
        thumb_url:
    ...
    },
    {
        ...
        desc: "Retired Old West gunslinger William Munny reluctantly takes on one last job, with the help of his old partner Ned Logan and a young man, The `quot;Schofield Kid.`quot;",
    ...
    },
    {
        ...
        desc: "Ultimate L.A. slacker Jeff `quot;The Dude`quot; Lebowski, mistaken for a millionaire of the same name, seeks restitution for a rug ruined by debt collectors, enlisting his bowling buddies for help while trying to find the millionaire`s miss...",
    ...
    },
    {
        ...
        desc: "Blacksmith Will Turner teams up with eccentric pirate `quot;Captain`quot; Jack Sparrow to save his love, the governor`s daughter, from Jack`s former pirate allies, who are now undead.",
    ...
    },
    {
        ...
        desc: "In 1938, after his father Professor Henry Jones, Sr. goes missing while pursuing the Holy Grail, Professor Henry `quot;Indiana`quot; Jones, Jr. finds himself up against Adolf Hitler`s Nazis again to stop them from obtaining its powers.",
        directors: ["Steven Spielberg"],
        genre: ["Action", "Adventure"],
        image_url:
    ...
    },
    {
        ...
        genre: ["Animation", "Adventure", "Comedy"],
        image_url: "https://image.tmdb.org/t/p/original/eHuGQ10FUzK1mdOY69wF5pGgEf5.jpg",
        thumb_url:
    ...
    },
    {
        ...
        desc: "After a boy loses his sister`s pair of shoes, he goes on a series of adventures in order to find them. When he can`t, he tries a new way to `quot;win`quot; a new pair.",
    ...
    },
    {
        ...
        desc: "Two friends are searching for their long lost companion. They revisit their college days and recall the memories of their friend who inspired them to think differently, even as the rest of the world called them `quot;idiots`quot;.",
